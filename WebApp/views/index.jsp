...
<div id="header"> 
	...
	<form action="" method="post" id="info"> 
		...
		<input type="password" id="pass" name="pass"> 	<input id="loginbutton" type="submit" value="·Î±×ÀÎ">
		</div>
...
<div id="container">
	<div id = "box">
	<div id="left">
	<h2>Facebook¿¡¼­ Àü¼¼°è¿¡ ÀÖ´Â Ä£±¸, °¡Á·, ÁöÀÎµé°ú<br> ÇÔ²² ÀÌ¾ß±â¸¦ ³ª´²º¸¼¼¿ä.</h2>
  ...
  <div id="footer"><p>made by ÀÌÀºÈ£, Á¦¹ÎÀç</p></div>
